...
export default {
  ...
  sub: {
    ...
    deleteAddendums: 'Удалить доп. файл',
    loadCVAddendumHeader: 'Загрузить/Изменить доп. файл',
    addendumUrlUploaded: 'Доп. файл загружен',
    addendumUrlNone: 'Доп. файл не загружен'
  },
  upl: {
  ...
  addCv: {
    ...
    telValidationFormat: 'Неправильный формат номера',
    ...
    jobTitleOptions: ["Агроном", "Администратор", "Аудитор", "Адвокат", "Бухгалтер", "Водитель", "Воспитатель", "Геодезист", "Гладильщица", "Грузчик", "Дизайнер", "Дом работница", "Донерчи", "Доставщик", "Заведующий складом", "Инженер", "ИТ специалист ", "Кассир", "Кондитер", "Лингвист", "Логист", "Маркетолог", "Мебельщик", "Мед работник", "Менеджер", "Мерчендайзер", "Механик", "Монтажник", "Начальник", "Няня", "Офис менеджер", "Оператор", "Оператор 1С", "Отдел кадров", "Охранник", "Оценщик", "Пекарь", "Переводчик", "Повар", "Помощник директора", "Программист", "Продавец", "Проектировщик", "Рабочий", "Репетитор", "Реставратор мебель", "Садовник", "Сантехник", "Секретарь", "Сиделка", "Снабженец", "Специалист по тендерам", "Технолог", "Торговый агент", "Уборщица", "Упаковщица", "Флорист", "Швея", "Экономист", "Электрик", "Электромонтажник", "Юрист"]
  },
  cvList: {
  ...
  addJob: {
    ...
    langOptions: ["Туркменский", "Русский", "Английский", "Китайский", "Турецкий", "Испанский", "Немецкий", "Французкий", "Болгарский", "Греческий", "Голландский"],
  ...
  entProfile: {
    ...
    previewHint: 'Посмотреть доп. файл в google docs',
    downloadHint: 'Скачать доп. файл',
    previewCv: 'Посмотреть резюме',
    cvDeleted: 'Резюме удалено'
  },
  jobsStats: {
    title: 'Название',
